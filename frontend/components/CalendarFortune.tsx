        ...
        <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 space-y-6 shadow-2xl backdrop-blur-xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 space-y-2">
                <label className="flex items-center gap-2 text-sm font-medium text-gray-400">
                  <Sparkles size={16} className="text-orange-500" /> Giờ sinh (Càng chính xác càng tốt)
                </label>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 animate-in fade-in slide-in-from-top-4 duration-700">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xl font-bold">Bản Đồ Sao Cá Nhân</h2>
              </div>
              <span className="px-3 py-1 bg-orange-500/20 text-orange-400 rounded-full text-[10px] font-bold border border-orange-500/30">
                Natal Chart
              </span>
            </div>
              ...
              <div className="space-y-6">
                <div className="p-6 bg-white/5 border border-white/10 rounded-2xl">
                  <h3 className="text-lg font-bold text-orange-400 mb-4 flex items-center gap-2">
                    <Info size={18} /> Tại sao cần bản đồ sao?
                  </h3>
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Bản đồ sao là "dấu vân tay" linh hồn của bạn tại thời điểm sinh ra. Bằng cách đối chiếu vị trí các hành tinh quá cảnh hiện tại với bản đồ gốc này, AI có thể tính toán chính xác những ngày mà năng lượng vũ trụ cộng hưởng tốt nhất với bạn.
                  </p>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-black/40 border border-white/5 rounded-xl text-center">
                    <div className="text-xs text-gray-500 uppercase mb-1">Thế mạnh</div>
                    <div className="text-white font-bold">Bản nguyên</div>
                  </div>
                  <div className="p-4 bg-black/40 border border-white/5 rounded-xl text-center">
                    <div className="text-xs text-gray-500 uppercase mb-1">Cơ hội</div>
                    <div className="text-white font-bold">Tiềm năng</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div ref={calendarRef} className="space-y-6 bg-[#0a0a0f] p-2 md:p-4 rounded-2xl">
          ...
          <div className="bg-[#0a0a0f] border border-white/10 rounded-2xl p-6 shadow-xl relative">
            ...
            <div className="text-center mb-6">
               <h2 className="text-xl font-bold text-white uppercase tracking-widest">Tháng {targetDate.month} / {targetDate.year}</h2>
               <p className="text-orange-500 text-[10px] mt-1">Lịch Cát Tường Chiêm Tinh</p>
            </div>
          ...
          {summary && (
            <div className="bg-[#0f0f15] border border-white/10 rounded-2xl p-6 shadow-xl">
              ...
              <div className="space-y-3 border-t border-white/10 pt-6">
                <h3 className="text-base font-bold text-white mb-3">Chi tiết các ngày đặc biệt:</h3>
