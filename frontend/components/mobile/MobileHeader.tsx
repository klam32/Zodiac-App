...
const MobileHeader: React.FC<MobileHeaderProps> = ({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-[#07070c]/90 backdrop-blur-md border-b border-white/5 flex items-center justify-between px-4 z-[99] h-16 box-border select-none" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
