            ...
            {chartSvg && (
              <div className="mb-10 animate-in fade-in slide-in-from-top-4 duration-700">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-lg font-bold text-white uppercase tracking-tight">Bản đồ sao cá nhân</h3>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-[2rem] p-6 md:p-10">
                   ...
                   <p className="text-gray-400 text-sm mt-8 text-center leading-relaxed">
                     Dựa trên bản đồ sao gốc của bạn, năng lượng ngày hôm nay tập trung mạnh mẽ vào các góc chiếu ảnh hưởng tới lĩnh vực <span className="text-purple-400 font-bold">{CATEGORIES.find(c => c.id === selectedField)?.name}</span>.
                   </p>
                </div>
              </div>
            )}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="flex items-center gap-2 text-xs font-black text-purple-400 uppercase tracking-widest mb-3">
                    <Zap className="w-3 h-3" /> Giờ sinh
                  </label>
                  <input
                    type="time"
                    value={formData.time}
