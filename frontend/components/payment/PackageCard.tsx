  ...
  return (
    ...
    >
      ...
      <div className="flex items-baseline gap-1 mb-6">
          ...
          <span className="text-stone-400 text-sm font-medium uppercase tracking-widest">{t('payment.tokens', 'tokens')}</span>
      </div>
      
      <div className="space-y-3 mb-8 text-sm text-stone-500">
          <p className="flex items-center gap-2">
              <svg className="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg>
              {t('payment.noExpiry', 'Không giới hạn thời gian')}
          </p>
          <p className="flex items-center gap-2">
              <svg className="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg>
              {t('payment.priorityResponse', 'Tốc độ trả lời ưu tiên')}
          </p>
      </div>
      ...
      >
        ...
        <span className="text-[10px] opacity-70 font-normal uppercase tracking-tighter">
          {t('payment.topUpVietQR', 'Nạp ngay qua VietQR')}
        </span>
      </button>
    </div>
  );
